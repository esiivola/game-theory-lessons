...
// stable in the KMR finite-population, best-response-with-mutation model: it is the one the
// population spends almost all its time at in the long run.
...
/** The risk-dominant, hence KMR-stochastically stable, convention: the larger basin. */
